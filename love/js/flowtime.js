...
*/
	...
	var NavigationMatrix = (function ()
	{
		...
		function _showFragment(fp, fsp, f)
		{
			...
			for (var i = 0; i <= f;="" i++)="" {="" brav1toolbox.addclass(fragmentsarray[fp][fsp][i],="" fragment_revealed_class);="" brav1toolbox.removeclass(fragmentsarray[fp][fsp][i],="" fragment_actual_class);="" }="" brav1toolbox.addclass(fragmentsarray[fp][fsp][f],="" **="" *="" hide="" a="" single="" fragment="" inside="" the="" specified="" section="" page="" index="" parameter="" is="" optional,="" if="" passed="" force="" to="" otherwise="" method="" hides="" current="" @param="" fp="" number="" fsp="" f="" (optional)="" function="" _hidefragment(fp,="" fsp,="" f)="" (f="" !="undefined)" fr[fp][fsp]="f;" else="" for="" (var="" i="0;" <="" fragmentsarray[fp][fsp].length;="" (i="">= f)
				{
...
*/
	...
	function onKeyDown(e)
	{
		...
		{
			if (e.keyCode >= 37 && e.keyCode <= 13="" 27="" 33="" 34="" 35="" 36="" 37="" 38="" 39="" 40="" 40)="" {="" e.preventdefault();="" }="" function="" onkeyup(e)="" var="" tag="e.target.tagName;" elem;="" if="" (tag="" !="INPUT" &&="" )="" switch="" (e.keycode)="" case="" :="" esc="" _toggleoverview(true);="" break;="" pag="" up="" _gototop();="" down="" _gotobottom();="" end="" _gotoend();="" home="" _gotohome();="" left="" _prevsection(e.shiftkey);="" right="" _nextsection(e.shiftkey);="" _prevpage(e.shiftkey);="" _nextpage(e.shiftkey);="" return="" (isoverview)="" _gotopage(navigationmatrix.getcurrenthilited());="" default *="" ########="" ##="" ####="" ######="" ###="" #########="" #######="" **="" triggers="" the="" first="" animation="" when="" visiting="" site="" hash="" is="" not="" empty="" _start()="" init="" and="" configuration="" (_showprogress="" defaultprogress="=" null)="" buildprogressindicator();="" start="" navigation="" (document.location.hash.length=""> 0)
		{
