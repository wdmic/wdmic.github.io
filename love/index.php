...
<head>
	...
	<meta name="author" content="情人节,表白,情人节表白,自动生成表白,自动表白">
	<meta name="description" content="这是一个自动生成表白页面的网站，仅限娱乐，不得用于商业用途">
	<title>情人节自动生成表白网站</title>
	<link rel="stylesheet" href="css/all.min.css">
<!-- mrlong.cc Baidu tongji analytics -->
<script>
var _hmt = _hmt || [];
(function() {
var hm = document.createElement("script");
hm.src = "https://hm.baidu.com/hm.js?d5f3c5a8c591f8cd2a659cd8e971c427";
	...
	<div class="flowtime">
		<div class="ft-section section-1" data-id="section-1">
			<div id="/section-1/page-1" class="ft-page page-1" data-id="page-1">
				...
				<p class="text2">按键盘 "↓" <span id="text-78" contenteditable="true">开始倾听我的表白 按"ESC"有惊喜哦</span></p>
			</div>
